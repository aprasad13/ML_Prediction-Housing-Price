...
m, b = np.polyfit(df_train[var],df_train['SalePrice'], 1)
plt.plot(df_train[var], m*df_train[var] + b,color='red')

# we see some outlier where GrLivArea>4000 and SalePrice<250000. we find its index
df_train[(df_train['GrLivArea']>4000) & (df_train['SalePrice']<250000)][['SalePrice','GrLivArea','OverallQual']]

#      SalePrice  GrLivArea OverallQual
#303     160000       5642          10

df_train[(df_train['GrLivArea']>4000) & (df_train['SalePrice']<250000)].index
#Int64Index([1298]
...
df_train_noNull = copy.deepcopy(df_train) 
...
df_train_noNull21.to_csv(r'/Users/amanprasad/Documents/Kaggle/House Prices/df_train_All_noNull21_V2.csv', index = False)
