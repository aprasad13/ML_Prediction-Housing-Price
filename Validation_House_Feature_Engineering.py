...
df_train_original_FeatEngg = pd.read_csv('/Users/amanprasad/Documents/Kaggle/House Prices/df_validation_noNull21.csv')
...
#-------------------------------------------------------------------------------------------------------------------------------
# introducing missing columns in train and validation

test_df_FeatEngg_8_columns=df_FeatEngg_8.columns

train_splitted = pd.read_csv('/Users/amanprasad/Documents/Kaggle/House Prices/House_File_V2/df_train_Splitted_FeatEngg_8_V2.csv')

train_splitted_columns=train_splitted.columns


col_missing_in_train_splitted=list(set(train_splitted_columns)-set(test_df_FeatEngg_8_columns))
...
['Exterior1st_Stone',
 ...
 'Exterior1st_Other',
 'RoofMatl_Metal',
 'GarageYrBlt_interval_before_1901',
 'RoofStyle_Shed',
 'Condition2_Other']
'''

col_missing_in_validation=list(set(test_df_FeatEngg_8_columns)-set(train_splitted_columns))
'''
{'Condition2_PosA',
 'Exterior1st_BrkComm',
...
for i in range(len(col_missing_in_train_splitted)):
    df_FeatEngg_9[col_missing_in_train_splitted[i]]=0

for i in range(len(col_missing_in_validation)):
    train_splitted[col_missing_in_validation[i]]=0


#-------------------------------------------------------------------------------------------------------------------------------
# exporting df_FeatEngg_9 into csv
df_FeatEngg_9.to_csv(r'/Users/amanprasad/Documents/Kaggle/House Prices/df_validation_FeatEngg_9.csv', index = False)

# exporting train_splitted into csv
train_splitted.to_csv(r'/Users/amanprasad/Documents/Kaggle/House Prices/df_train_Splitted_V1.csv', index = False)
