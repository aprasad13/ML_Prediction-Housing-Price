...
df_train_1, df_validation = train_test_split(df_train, test_size = 0.3, random_state = 60616, stratify = df_train['OverallQual'])
...
# GrLivArea
var = 'GrLivArea'
data = pd.concat([df_train['SalePrice'], df_train_1[var]], axis=1)
data.plot.scatter(x=var, y='SalePrice', ylim=(0,800000));

m, b = np.polyfit(df_train_1[var],df_train_1['SalePrice'], 1)
plt.plot(df_train_1[var], m*df_train_1[var] + b,color='red')

# we see some outlier where GrLivArea>4000 and SalePrice<250000. we find its index
df_train_1[(df_train_1['GrLivArea']>4000) & (df_train_1['SalePrice']<250000)][['SalePrice','GrLivArea','OverallQual']]

#      SalePrice  GrLivArea OverallQual
#303     160000       5642          10

df_train_1[(df_train_1['GrLivArea']>4000) & (df_train_1['SalePrice']<250000)].index
#Int64Index([1298]
...
null_all=df_train_1.isnull().sum()
null_all.size
type(null_all)
null_all['PoolQC']
...
df_train_noNull = copy.deepcopy(df_train_1) 
...
#column = BsmtQual and missing_value = 37
#column = BsmtCond and missing_value = 37
#column = BsmtExposure and missing_value = 38
#column = BsmtFinType1 and missing_value = 37
#column = BsmtFinSF1 and missing_value = 0
#column = BsmtFinType2 and missing_value = 38
...
df_train_noNull21.to_csv(r'/Users/amanprasad/Documents/Kaggle/House Prices/df_train_noNull21_V2.csv', index = False)
